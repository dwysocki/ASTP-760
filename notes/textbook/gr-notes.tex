...
\subfile{./tex/gr-ch3-notes}
%\subfile{./tex/gr-ch4-notes}
\subfile{./tex/gr-ch5-notes}
\subfile{./tex/gr-ch6-notes}
\subfile{./tex/gr-ch7-notes}
\subfile{./tex/gr-ch8-notes}
